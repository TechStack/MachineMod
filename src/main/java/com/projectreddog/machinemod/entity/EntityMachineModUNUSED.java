...
public class EntityMachineModUNUSED extends Entity {
	...
	private double entityYaw;
	private double entityPitch;
	...
	public EntityMachineModUNUSED(World world)
	{
	...
	public void setPositionAndRotation2(double p_70056_1_, double p_70056_3_, double p_70056_5_, float p_70056_7_, float p_70056_8_, int p_70056_9_)
	{
		if (this.isEmpty)
		{
			this.posRotationIncrements = p_70056_9_ + 5;
		}
		else
		{
		...
		this.entityX = p_70056_1_;
		this.entityY = p_70056_3_;
		this.entityZ = p_70056_5_;
		this.entityYaw = (double)p_70056_7_;
		this.entityPitch = (double)p_70056_8_;
...
//		}
		...
		if (this.worldObj.isRemote)
		{
			...
			{
				d2 = this.posX + (this.entityX - this.posX) / (double)this.posRotationIncrements;
				d4 = this.posY + (this.entityY - this.posY) / (double)this.posRotationIncrements;
				d11 = this.posZ + (this.entityZ - this.posZ) / (double)this.posRotationIncrements;
				d12 = MathHelper.wrapAngleTo180_double(this.entityYaw - (double)this.rotationYaw);
				this.rotationYaw = (float)((double)this.rotationYaw + d12 / (double)this.posRotationIncrements);
				this.rotationPitch = (float)((double)this.rotationPitch + (this.entityPitch - (double)this.rotationPitch) / (double)this.posRotationIncrements);
...
//				this.motionZ *= 0.5D;
	...
	//	      this.setRotation(this.rotationYaw, this.rotationPitch);
	//	      motionX += riddenByEntity.motionX * .5; // * 0.05000000000000001D;
	//	      motionZ += riddenByEntity.motionZ * .5; // * 0.05000000000000001D;
	//	     
	//	      if (motionX > 1)
	//	      {
	//	    	  motionX=1;
